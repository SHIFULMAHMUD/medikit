...
import com.app.medikit.adapter.ContactAdapter;
...
public class ContactsFragment extends DialogFragment {
    ...
    private void setAllContacts(){
        try {
            ...
            Cursor phones = MedkitController.getActivity().getContentResolver().query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, null,null,null, null);
            assert phones != null;
