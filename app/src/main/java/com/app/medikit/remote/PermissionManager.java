package com.app.medikit.remote;
...
import com.app.medikit.fragment.AlertDialogFragment;
...
public class PermissionManager {
    ...
    public PermissionManager() {
        this.activity = MedkitController.getActivity();
    }
    ...
    public void goToPermissionSetting(){
        Activity activity = MedkitController.getActivity();
